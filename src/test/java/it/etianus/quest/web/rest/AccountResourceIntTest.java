...
import it.etianus.quest.config.Constants;
import it.etianus.quest.QuesttestApp;
import it.etianus.quest.domain.Authority;
import it.etianus.quest.domain.User;
import it.etianus.quest.repository.AuthorityRepository;
import it.etianus.quest.repository.UserRepository;
import it.etianus.quest.security.AuthoritiesConstants;
import it.etianus.quest.service.MailService;
import it.etianus.quest.service.dto.UserDTO;
import it.etianus.quest.web.rest.errors.ExceptionTranslator;
import it.etianus.quest.web.rest.vm.KeyAndPasswordVM;
import it.etianus.quest.web.rest.vm.ManagedUserVM;
import it.etianus.quest.service.UserService;
