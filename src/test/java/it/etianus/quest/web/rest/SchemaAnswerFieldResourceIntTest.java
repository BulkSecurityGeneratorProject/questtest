...
import it.etianus.quest.repository.SchemaAnswerFieldRepository;
import it.etianus.quest.service.SchemaAnswerFieldService;
...
public class SchemaAnswerFieldResourceIntTest {
    ...
    public void createSchemaAnswerField() throws Exception {
        ...
        assertThat(testSchemaAnswerField.getFieldValue()).isEqualTo(DEFAULT_FIELD_VALUE);
    }
    ...
    public void updateSchemaAnswerField() throws Exception {
        ...
        SchemaAnswerField testSchemaAnswerField = schemaAnswerFieldList.get(schemaAnswerFieldList.size() - 1);
        assertThat(testSchemaAnswerField.getFieldValue()).isEqualTo(UPDATED_FIELD_VALUE);
    }
