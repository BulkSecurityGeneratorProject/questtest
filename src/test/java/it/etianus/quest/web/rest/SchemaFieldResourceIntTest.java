package it.etianus.quest.web.rest;

import it.etianus.quest.QuesttestApp;

import it.etianus.quest.domain.SchemaField;
import it.etianus.quest.repository.SchemaFieldRepository;
import it.etianus.quest.service.SchemaFieldService;
import it.etianus.quest.web.rest.errors.ExceptionTranslator;
...
import static it.etianus.quest.web.rest.TestUtil.createFormattingConversionService;
...
@SpringBootTest(classes = QuesttestApp.class)
public class SchemaFieldResourceIntTest {
    ...
    private static final TypeEnum DEFAULT_FIELD_TYPE = TypeEnum.CHAR;
    private static final TypeEnum UPDATED_FIELD_TYPE = TypeEnum.INTG;
    ...
    public void createSchemaField() throws Exception {
        ...
        assertThat(testSchemaField.getFieldOrder()).isEqualTo(DEFAULT_FIELD_ORDER);
        assertThat(testSchemaField.getFieldType()).isEqualTo(DEFAULT_FIELD_TYPE);
    ...
    @Test
    @Transactional
    public void checkFieldOrderIsRequired() throws Exception {
        int databaseSizeBeforeTest = schemaFieldRepository.findAll().size();
        // set the field null
        schemaField.setFieldOrder(null);
    ...
    public void updateSchemaField() throws Exception {
        ...
        assertThat(testSchemaField.getFieldOrder()).isEqualTo(UPDATED_FIELD_ORDER);
        assertThat(testSchemaField.getFieldType()).isEqualTo(UPDATED_FIELD_TYPE);
